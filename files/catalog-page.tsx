...
export const metadata: Metadata = {
  ...
  description:
    "אוסף של מעל 10,000 ספרים אקדמיים נדירים: פילוסופיה, היסטוריה, יהדות, פילולוגיה ועוד. משלוח לכל העולם.",
};
  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" dir="rtl">
        ...
        {/* ── כותרת הקטלוג ── */}
        <section className="mb-8 rounded-2xl bg-white/70 border border-burgundy-100 shadow-sm px-5 py-6 sm:px-8">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
            ...
            {hasFilters && (
              <a
                href="/catalog"
                className="inline-flex items-center gap-1.5 text-sm text-burgundy-700 hover:text-burgundy-900 hover:underline"
              >
                <span>×</span>
                <span>נקה חיפוש</span>
              </a>
        ...
        {books.length === 0 ? (
          <section className="text-center py-24 text-gray-400 rounded-2xl bg-white border border-gray-100 shadow-sm">
            ...
            <p className="text-sm mt-1">נסה לשנות את הפילטרים או את מילות החיפוש</p>
            <a
              href="/catalog"
              className="mt-4 inline-block text-burgundy-700 hover:underline text-sm font-medium"
            >
              הצג את כל הקטלוג
            </a>
          </section>
